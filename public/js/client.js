...
$(function() {
	...
	socket.on('enter',function(nick) {
						...
						var chat = '<div id="chatWrapper"><div id="onlineUserWidget"></div><div id="instance"><p id="instance-id"">Instance ID: <span id="instance-id-value"></span></p></div><div id="chatMainFrame"><ul id="messages"></ul><form id="chat" action=""><input type="submit" id="inputSubmit"><div id="smilies">'
								+ smilies
